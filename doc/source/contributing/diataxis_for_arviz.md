...
There are however some specificities to XGenTS case and knowing Diátaxis alone
is not enough to be able to understand XGenTS doc structure and correctly place
new content pages within it.
At the same time, having a basic understanding of Diátaxis is needed to understand
this page and the content structure in XGenTS docs.
...
The scope of the XGenTS website however is not limited to XGenTS users nor it is limited to practical
crafts like using XGenTS or contributing to it.
...
and general information about the XGenTS project,
it's people, community, marketing info...
which can nor should follow the Diátaxis framework.

## Strong visual component
XGenTS is a library with a strong visualization component.
...
their name nor the right XGenTS function to find it in the Example Gallery.

## Work in progress
In addition, XGenTS documentation itself and the application of Diátaxis to it
