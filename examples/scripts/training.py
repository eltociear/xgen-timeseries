...
def main(args):
    ...
    if args.dataset == "mnist":
        ...
        if args.nn == "convnet":
            ...
            from XGen.models.nn.benchmarks.mnist import (
        ...
        if args.nn == "convnet":
            ...
            from XGen.models.nn.benchmarks.cifar import (
        ...
        if args.nn == "convnet":
            ...
            from XGen.models.nn.benchmarks.celeba import (
    ...
    if args.model_name == "ae":
        from XGen.models import AE, AEConfig
        ...
        from XGen.models import IWAE, IWAEConfig
        ...
        from XGen.models import INFOVAE_MMD, INFOVAE_MMD_Config
        ...
        from XGen.models import RAE_L2, RAE_L2_Config
        ...
        from XGen.models import RAE_GP, RAE_GP_Config
        ...
        from XGen.models import VAMP, VAMPConfig
        ...
        from XGen.models import BetaVAE, BetaVAEConfig
        ...
        from XGen.models import HVAE, HVAEConfig
        ...
        from XGen.models import RHVAE, RHVAEConfig
        ...
        from XGen.models import Adversarial_AE, Adversarial_AE_Config
        ...
        from XGen.models import VAEGAN, VAEGANConfig
        ...
        from XGen.models import VQVAE, VQVAEConfig
        ...
        from XGen.models import MSSSIM_VAE, MSSSIM_VAEConfig
        ...
        from XGen.models import SVAE, SVAEConfig
        ...
        from XGen.models import DisentangledBetaVAE, DisentangledBetaVAEConfig
        ...
        from XGen.models import FactorVAE, FactorVAEConfig
        ...
        from XGen.models import BetaTCVAE, BetaTCVAEConfig
        ...
        from XGen.models import VAE_IAF, VAE_IAF_Config
        ...
        from XGen.models import VAE_LinNF, VAE_LinNF_Config
